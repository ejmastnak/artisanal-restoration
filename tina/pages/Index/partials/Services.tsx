...
export default function Services({ homePage, }: Props) {
  return (
    <div>
      <h2 data-tina-field={tinaField(homePage, "servicesHeading")} className="text-center text-4xl md:text-5xl font-['Latin_Modern_Roman']">{homePage.servicesHeading}</h2>
      <div className="flex flex-col gap-y-5 md:flex-row-reverse mt-6 md:mt-10 px-6 text-gray-700">
        <img
          data-tina-field={tinaField(homePage, "servicesImage")}
        ...
        <div className="md:px-8 mx-auto md:mx-0">
          <div data-tina-field={tinaField(homePage, "servicesSummary")} className="prose max-w-md text-center md:text-left">
            <TinaMarkdown content={homePage.servicesSummary} />
          </div>
          <div className="mt-8 w-fit mx-auto">
            <LinkButton data-tina-field={tinaField(homePage, "servicesLinkText")} tinaField={tinaField(homePage, "servicesLinkText")} href="/services">
